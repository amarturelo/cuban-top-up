...
public class PromotionsListSpinnerAdapter extends ArrayAdapter<PromotionItemModel> implements ThemedSpinnerAdapter {
    ...
    public PromotionsListSpinnerAdapter(Context context, PromotionItemModel[] objects) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        textView2.setText(DateUtils.getRelativeTimeSpanString(getItem(position).getStartDate().getTime()));
        return view;
    }
